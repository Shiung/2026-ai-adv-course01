...
createApp({
  setup() {
    ...
    const paymentMessages = {
      ...
      failed: { text: '付款失敗，請重試或聯繫客服。', cls: 'bg-red-50 text-red-600 border border-red-100' },
    ...
    async function goToPayment() {
      ...
      try {
        ...
        // Build and auto-submit form to ECPay
    ...
    async function verifyPayment() {
      ...
      try {
        const res = await apiFetch('/api/orders/' + order.value.id + '/verify-payment', {
          method: 'POST'
        });
